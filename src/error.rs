...
mod tests {
    ...
    fn test_task_not_found_error() {
        ...
        let err = TaskRunnerError::TaskNotFound(id);
    ...
    #[test]
    fn test_task_error_to_api_error() {
        let task_err = TaskRunnerError::TaskNotFound(uuid::Uuid::new_v4());
        let api_err: ApiError = task_err.into();
